            ...
            <div className="space-y-4 leading-relaxed text-gray-300">
              ...
              <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-6">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    -
                    運営者は、本サービスで提供される情報、レポート、コード等の正確性、安全性、適切性、または特定の目的への適合性について一切の保証を行いません。
                  </li>
                  <li>
                    -
                    本サービスが提供する情報やレポート（金融・エネルギー等の分析を含む）に基づいて行われた投資等の判断、あるいはコードを実際のプロジェクトに適用した結果生じたいかなる損害についても、運営者は一切の責任を負いません。
                  </li>
                  <li>
                    -
                    本サービスの情報は投資勧誘を目的としたものではありません。最終的な決定は、ユーザーご自身の判断と責任において行ってください。
                  </li>
                </ul>
              </div>
            </div>
