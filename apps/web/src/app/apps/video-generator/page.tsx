...
export default function VideoGeneratorPage() {
  ...
  const startPlayback = (startIndex: number, imagesList: string[]) => {
    ...
    // Play speech if browser supports Web Speech API
  ...
  return (
    <main className="bg-background min-h-screen py-16 text-white selection:bg-cyan-500/30 md:py-24">
      ...
      <div className="container mx-auto max-w-6xl px-6">
        {/* Header */}
        <div className="mb-12">
          <div className="glass mb-6 inline-flex items-center gap-2 rounded-full border-white/10 px-4 py-1.5">
          ...
          <h1 className="mb-4 text-5xl leading-none font-black tracking-tighter text-white md:text-7xl">
            AI VIDEO GENERATOR
          </h1>
          <p className="max-w-2xl text-lg leading-relaxed text-gray-400">
            台本（ナレーション＋画像プロンプト）を入力するだけで、瞬時にシーンごとのAI画像・音声プレビューを生成します。
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-12">
          ...
          <div className="space-y-6 lg:col-span-7">
            ...
            {/* Legal Notice & Submit Button */}
            <div className="pt-2">
              <div className="mb-4 rounded-xl border border-white/5 bg-white/[0.01] p-3 text-[11px] text-gray-500">
                <span>
                  生成を実行することで、当サービスの{' '}
                  ...
                  （入力データのモデル学習・データセット提供に関する同意を含む）に同意したものとみなされます。
                </span>
              </div>
