...
export const DEFAULT_CATEGORIES: Record<CategoryKey, CategoryConfig> = {
  INDEX:  { key: 'INDEX',  label: 'インデックス投信', color: '#3B82F6', ratio: 0.50 },
  STOCK:  { key: 'STOCK',  label: '個別株/ETF',      color: '#10B981', ratio: 0.20 },
  BOND:   { key: 'BOND',   label: '債券',           color: '#8B5CF6', ratio: 0.10 },
