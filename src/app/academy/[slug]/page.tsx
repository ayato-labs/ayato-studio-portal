...
export default async function AcademyDetailPage(props: PageProps) {
  ...
  return (
    <main className="bg-background min-h-screen overflow-x-hidden text-white selection:bg-indigo-500/30">
      <script
      ...
      <article className="mx-auto max-w-4xl px-6 py-12 md:py-24">
        ...
        <div className="mb-12">
          <Link
            href="/academy"
            className="mb-8 inline-flex items-center text-xs font-black tracking-widest text-indigo-400 uppercase transition-opacity hover:opacity-70"
          >
          ...
          <div className="flex items-center gap-6 rounded-3xl border border-white/5 bg-white/[0.02] p-6 backdrop-blur-xl">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-indigo-600 text-xs font-bold shadow-lg shadow-indigo-500/20">
                AI
              </div>
              <div>
        ...
        <div className="group relative">
          <div className="absolute -inset-4 -z-10 rounded-[3rem] bg-gradient-to-b from-indigo-600/5 to-transparent blur-2xl" />

          <div className="rounded-[3rem] border border-white/5 bg-black/40 p-8 shadow-2xl backdrop-blur-3xl md:p-16">
            <div className="prose prose-invert prose-indigo prose-headings:font-black prose-headings:tracking-tight prose-h1:text-3xl md:prose-h1:text-4xl prose-h1:mb-8 prose-h2:text-2xl md:prose-h2:text-3xl prose-h2:mb-6 prose-h2:mt-12 prose-h3:text-xl md:prose-h3:text-2xl prose-h3:mb-4 prose-h3:mt-10 prose-p:text-gray-300 prose-p:leading-relaxed prose-p:text-lg prose-li:text-gray-300 prose-li:text-lg prose-strong:text-white prose-strong:font-bold prose-hr:border-white/10 prose-hr:my-12 max-w-none">
        ...
        <div className="mt-20 flex items-center justify-between border-t border-white/5 pt-10">
          ...
          <Link
            href="/blog"
            className="text-xs font-black tracking-widest text-indigo-400 uppercase transition-colors hover:text-indigo-300"
          >
