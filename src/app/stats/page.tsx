...
export const metadata: Metadata = {
  ...
  description:
    '国内外の主要LLM（Large Language Models）の日本語性能ベンチマーク、推論速度、およびAPIコストに関する定量的な統計比較ダッシュボード。',
};
    ...
    <main className="bg-background relative min-h-screen overflow-x-hidden selection:bg-blue-500/30 selection:text-blue-200">
      ...
      <div className="container mx-auto max-w-6xl px-6 pt-32 pb-40 md:pt-48">
        ...
        <div className="mb-20 max-w-3xl">
          <h1
            id="stats-title"
            className="mb-8 text-5xl leading-none font-black tracking-tighter text-white uppercase md:text-7xl"
          >
            LLM BENCHMARK &<br />
            <span className="text-blue-600">COST STATISTICS</span>
          </h1>
          <p className="text-lg leading-relaxed text-gray-400">
            モデル開発元から提供されている公式仕様、および独立したベンチマーク（LMSYS
            Arena、JGLUEなど）から得られたデータを統合。
